...
var Core = function(OBSWebSocket) {
  ...
  OBSWebSocket.prototype.sendRequest = function(requestType, args = {}, callback = function() {}) {
    if (!this._connected) {
  ...
  OBSWebSocket.prototype.apiLookup = function(requestType, params = {}, callback = function() {}) {
    if (!this._connected) {
      this.log.error('Not connected.');
    }
